...
Project done during **Full Stack Software Engineering studies** at **ALX SE Program**. The project aims to learn about what is a binary tree, the different traversal methods while going through a binary tree and the different types of binary trees: `Complete` , `Full` , `Perfect` and `Balanced` .
